...
/**
 * [Class description]
 * Use cookie in an Android App ---------Called By MyVolley.groovy
 *  CookieStore wrapper with auto serializing cookie in Android SharedPreferences
 *      ----- in an Android device, SharedPreferences saved in /data/data/package name/shared_prefs/xxxx.xml
 *
 * code reference :
 ...
 *  but I added a few methods
 *
 *
 *  [Key API samples]
 *          note:   a.  single instance defined and initiated in MyVolley, use from it
 *                  b.  you SHOULD NOT call this class directly !!!
 *   0. get this store instance
 *   MyVolly.getCookieStore()
 *
 *   1. add a cookie
 *   myCookieStore.addCookie(Cookie)
 *
 *   2. get cookies --- @return arrayList<Cookie>
 *   myCookieStore.getCookies()
 *
 *   3. remove a cookie
 *   myCookieStore.deleteCookie(Cookie)
 *
 *   4. remove all cookies      ----@return boolean      true if any removed
 *   myCookieStore.clear()
 *
 *   5. myCookieStore.clearExpired(new Date())    //called in construction func
 */
...
public class PersistentCookieStore implements CookieStore {
    ...
    public ConcurrentHashMap<String, Cookie> getCookiesHashMap() {
        return cookies;
    }
    /**
